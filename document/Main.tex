...
This dataset is mostly based on Children with some Adults, Infants and Neonates in there.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{age_distribution.png}
    \caption{The age group distribution of the people in the dataset.}
\end{figure}
...
The metrics display a highly calibrated model. The balanced sensitivity and specificity ensure the system acts as a reliable filter without overwhelming cardiologists with false positives. This enables the first line doctors to effectively
screen the majority of patients and reduce the workload for cardiologists.
...
\bibitem{physionet2022}
Oliveira, J., et al. (2022). The CirCor DigiScope Phonocardiogram Dataset.\textit{https://physionet.org/content/circor-heart-sound/1.0.3/}.
